...
dev/lint:
	...
	@exec isort .
	@echo "Run black"
	@exec black request_id_helper tests
	@echo "Run flake"
	@exec flake8 request_id_helper tests
	@echo "Run bandit"
	@exec bandit -r request_id_helper/*
	@echo "Run mypy"
	@exec mypy request_id_helper
...
dev/test:
	@echo "Run tests"
	PYTHONPATH=${PYTHONPATH} PYTHONASYNCIODEBUG=x py.test -svvv -rs --cov request_id_helper --cov-report term-missing -x
